...
import com.thinkive.bank.videoplay.widget.CustomMediaController;
 ...
 * @description: 播放在线视频流界面
 */
public class VitamioUrlPlayActivity extends Activity  {
...
//                LogUtils.i(LogUtils.LOG_TAG, "what=" + what);
        ...
        mVideoView.setOnBufferingUpdateListener(new MediaPlayer.OnBufferingUpdateListener() {
            ...
            public void onBufferingUpdate(MediaPlayer mp, int percent) {
                MyLogger.i("vitamio","percent" + percent);
            }
        });
    }
    ...
    public void speedVideo() {
        if(mVideoView!=null){
            ...
            ToastUtils.showToast(this, StringUtils.generateTime(goalduration));
        }
    }

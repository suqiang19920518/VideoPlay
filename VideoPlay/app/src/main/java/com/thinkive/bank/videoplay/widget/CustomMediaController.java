package com.thinkive.bank.videoplay.widget;
...
import com.thinkive.bank.videoplay.activity.VitamioUrlPlayActivity;
import com.thinkive.bank.videoplay.util.BitmapUtils;
import com.thinkive.bank.videoplay.util.MyLogger;
import com.thinkive.bank.videoplay.util.RandomUtils;
import com.thinkive.bank.videoplay.util.ToastUtils;
...
public class CustomMediaController extends MediaController {
    ...
    VitamioUrlPlayActivity activity;
    ...
    public CustomMediaController(Context context) {
        ...
        activity = (VitamioUrlPlayActivity) context;
    ...
    protected void initOtherView() {
        ...
        mediacontroller_snapshot.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //保存到本地
                String picturnPath = activity.getExternalCacheDir() + File.separator + RandomUtils.getRandomLetters(6) + ".jpg";
                boolean saveSuccess = BitmapUtils.saveBitmap(currentFrame, new File(picturnPath));
                if (saveSuccess) {
                    ToastUtils.showToast(activity, "截屏保存到" + picturnPath, Toast.LENGTH_LONG);
                } else {
                    ToastUtils.showToast(activity, "截屏失败", Toast.LENGTH_LONG);
                }
            }
        });
        ...
        mediacontroller_screen_fit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ToastUtils.showToast(activity, strDialogs[mCurrentPageSize]);
        ...
        mRoot.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                MyLogger.i("vitamioPlay", "onTouchEvent");
